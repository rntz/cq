...
cq operates within an B<instance>. An instance is identified by its control
...
its output. (At present, this use of screen is hardcoded; in the future, this
...
The default control directory. This is where cq stores job files, the job queue,
lock files, and the other state it maintains.
